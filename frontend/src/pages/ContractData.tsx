...
import { preprocessContract, type PreprocessResponse } from '../services/contracts'
        ...
        <Row gutter={[16, 16]} align="middle">
          ...
          <Col>
            <Space>
              ...
              <Button type="primary" loading={busy} disabled={!canRun} onClick={onRun}>
                开始预处理
              </Button>
            </Space>
          </Col>
            ...
            >
                ...
                <Space>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      const base =
                        tab === 'upload'
                          ? (fileList[0]?.name?.replace(/\.sol$/i, '') ?? 'contract')
                          : 'pasted'
              ...
              <Row gutter={[16, 12]}>
                ...
                <Col xs={12} sm={6}>
                  <Statistic
                    title="处理后行数"
                    value={stats?.processed.lines ?? (processed ? countLines(processed) : 0)}
                  />
                </Col>
                <Col xs={12} sm={6}>
